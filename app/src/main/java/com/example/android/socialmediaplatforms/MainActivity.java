...
import com.example.android.socialmediaplatforms.R;
import com.linkedin.platform.APIHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getPackageHash() {
        try {
            ...
            @SuppressLint("PackageManagerGetSignatures") PackageInfo info = getPackageManager().getPackageInfo(
                    "com.example.android.socialmediaplatforms",//give your package name here
    ...
    private void fetchBasicProfileData() {
        ...
        //LINK : https://developer.linkedin.com/docs/fields/basic-profile
        String url = "https://api.linkedin.com/v1/people/~:(id,first-name,last-name,headline,public-profile-url,picture-url,email-address,picture-urls::(original))";
//https://sofia100.auth0.com/login/callback     https://linkedin.com/in/sofia-sunam-5567ab172/
   //https://sofia100.auth0.com/login/callback?code=AQShNvwIB72i8GmgMctGSAP5yF9BaffS3bEoldJxL7C1UcDJRPJ9LbTHUkcep2i7mi6H6OGvLWZEbPQq3vU-8dqfqvkXO-wA1xP_RPEIE_h32D1euHWMJf4FCr0LsPUM1TEA_Abea5yV78-GpsaIoyqZuPr_lLAwBDR1edrL7bi10fkgFb1WgWjHJZ6oAg&state=aRandomString
        APIHelper apiHelper = APIHelper.getInstance(getApplicationContext());
        apiHelper.getRequest(this, url, new ApiListener() {
            @Override
            public void onApiSuccess(ApiResponse apiResponse) {
            ...
            if (apiResponse != null) {
                ...
                if (pictureURLObject.getInt("_total") > 0) {
                    ...
                    if (profilePictureURLArray != null && profilePictureURLArray.length() > 0) {
                        ...
                        Picasso.get().load(profilePictureURLArray.getString(0))
